...
namespace CookBook.Controllers
{
    public class RecipeController : Controller
    {
        ...
        public ViewResult Index(string searchString)
        {
            ...
            {
                recipes = recipes.Where(r => r.RecipeType.ToUpper().Contains(searchString.ToUpper()));
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,PrepTime,CookTime,NumberServ,Steps,RecipeType")] Recipe recipe)
        {
            if (ModelState.IsValid)
            {
