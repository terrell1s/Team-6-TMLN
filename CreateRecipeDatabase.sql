...
/****** Object:  Database [Recipe]    Script Date: 08/01/2014 09:41:04 ******/
CREATE DATABASE [Recipe] ON  PRIMARY 
( NAME = N'Recipe', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLEXPRESS\MSSQL\DATA\Recipe.mdf' , SIZE = 2048KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Recipe_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLEXPRESS\MSSQL\DATA\Recipe_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [Recipe] SET COMPATIBILITY_LEVEL = 100
GO
